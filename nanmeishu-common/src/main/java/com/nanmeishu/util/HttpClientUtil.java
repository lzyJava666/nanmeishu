...
public class HttpClientUtil {
    ...
    public static String sendPostByJson(String url, String jsonParam,int reSend) {
        ...
        try {
            // 创建连接
            httpClient = com.java.crawler.resource.utils.HttpClientFactory.getInstance().getHttpClient();
            // 设置请求头和报文
            HttpPost httpPost = com.java.crawler.resource.utils.HttpClientFactory.getInstance().httpPost(url);
